...
class AutoTestRunner:
    ...
    def run_pre_command(self, test_case, exp_res_list):
        start = time.time()
        try:
            # 发送测试命令
...
ramdom_byte_39 = DataHandle.random_bytes_string(39)
...
def get_mps_case_tests() -> List[TestCase]:
    return [
        ...
        TestCase(name="TCCHERYICC-26",
                 request="2E F1 8C" + ramdom_byte_39,
        ...
        TestCase(name="TCCHERYICC-27",
                 request="22 F1 8C ",
                 expected_response="62 F1 8C" + ramdom_byte_39,
                 session_required=6,
                 security_required=3,
                 ),
        ...
        TestCase(name="TCCHERYICC-95",
                 request="22 FD 0C",
                 expected_response="62FD0C005B0064005B00640046", # TBD
                 session_required=6,
                 security_required=3,
                 ),
